...
SCHEMA = "mdr-pair34-certificates-v1"
PROOF_MAX_LENGTH = 21
...
def verification_sha256(
    *, state_id: int, state_bytes: bytes, solution: bytes, beam_width: int,
    ...
    digest.update(b"MDRP34CERT1\x00")
...
class Pair34CertificateStore:
    def __init__(
        ...
        self.connection.executescript(
            ...
            CREATE TABLE IF NOT EXISTS certificates (
                ...
                solution_length INTEGER NOT NULL CHECK(solution_length BETWEEN 0 AND 21),
    ...
    def __enter__(self) -> "Pair34CertificateStore":
        return self
    ...
    def add(
        ...
        if len(solution_bytes) > PROOF_MAX_LENGTH or any(move >= 28 for move in solution_bytes):
            raise ValueError("invalid pair34 proof solution")
